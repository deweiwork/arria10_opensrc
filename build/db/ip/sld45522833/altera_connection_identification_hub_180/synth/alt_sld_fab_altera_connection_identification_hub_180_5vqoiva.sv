...
//
// Parameters
//   DESIGN_HASH   : a0d4a7b4cf27bd9af2cb
//   COUNT         : 1
//   ROM_WIDTHS    : 4
//   LATENCIES     : 0
//
...
module alt_sld_fab_altera_connection_identification_hub_180_5vqoiva
(
	input [4:0] address_0,
	input [3:0] contrib_0,
	output [3:0] rdata_0,
...
wire [127:0] data_0 = { mixed, 12'h0, 32'h0, 80'ha0d4a7b4cf27bd9af2cb };
