...
mkdir -p ./libraries/clk_buffer_altclkctrl_181/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altclkctrl_181/sim/clk_buffer_altclkctrl_181_4ev4gqi.vhd" -work clk_buffer_altclkctrl_181 -cdslib ./cds_libs/clk_buffer_altclkctrl_181.cds.lib
