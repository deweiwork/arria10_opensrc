...
if [ $SKIP_COM -eq 0 ]; then
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altclkctrl_181/sim/clk_buffer_altclkctrl_181_4ev4gqi.vhd" -work clk_buffer_altclkctrl_181
