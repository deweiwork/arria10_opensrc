...
# ----------------------------------------
# ACDS 18.1 625 linux 2018.10.25.16:55:08
...
ensure_lib                           ./libraries/clk_buffer_altclkctrl_181/
vmap       clk_buffer_altclkctrl_181 ./libraries/clk_buffer_altclkctrl_181/
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altclkctrl_181/sim/clk_buffer_altclkctrl_181_4ev4gqi.vhd" -work clk_buffer_altclkctrl_181
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L clk_buffer_altclkctrl_181 -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L twentynm -L twentynm_hssi -L twentynm_hip $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L clk_buffer_altclkctrl_181 -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L twentynm -L twentynm_hssi -L twentynm_hip $TOP_LEVEL_NAME
}
